    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'ponto_referencia', type: 'varchar', isNullable: false },
          { name: 'cep', type: 'varchar', isNullable: false },
          { name: 'localizacao_diferenciada', type: 'enum', enum: ['Não', 'Área de assentamento', 'Comunidade quilombola', 'Comunidade indígena', 'Comunidade tradicional'], isNullable: false },
          { name: 'zona', type: 'enum', enum: ['Urbana', 'Rural'], isNullable: false },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'nivel_acesso', type: 'enum', enum: ['Administrador', 'Administrador Municipal', 'Atendente Secretaria', 'Gestor de Creche', 'Defensoria'], isNullable: false },
          { name: 'situacao_cadastral', type: 'boolean', default: true },
          { name: 'created_at', type: 'timestamptz', default: 'now()' },
          { name: 'updated_at', type: 'timestamptz', default: 'now()' },
          { name: 'deleted_at', type: 'timestamptz', isNullable: true },
        ],
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'nivel_escolaridade', type: 'enum', enum: ['Ensino fundamental incompleto', 'Ensino fundamental completo', 'Ensino médio incompleto', 'Ensino médio completo', 'Superior incompleto', 'Ensino superior completo', 'Pós-graduação', 'Mestrado', 'Doutorado'], isNullable: false },
          { name: 'tipo_ensino_medio', type: 'enum', enum: ['Formação geral', 'Modalidade normal (magistério)', 'Curso técnico', 'Magistério indígena - modalidade normal'], isNullable: false },
          { name: 'pos_graduacao_concluida', type: 'enum', enum: ['Especialização', 'Mestrado', 'Doutorado', 'Não tem pós-graduação concluída'], isNullable: false },
          { name: 'cargo', type: 'enum', enum: ['Administrador Sistema', 'Gestor', 'Analista', 'Operador', 'Outro'], isNullable: true },
          { name: 'tipo_vinculo', type: 'enum', enum: ['Unidade Escolar', 'Secretaria Municipal'], isNullable: true },
