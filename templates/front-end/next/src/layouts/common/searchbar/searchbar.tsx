...
import { useBoolean, useEventListener, useResponsive } from '@softlutions/hooks';
...
import { useNavData } from '../../dashboard/dashboard-config-navigation';
...
function Searchbar() {
  ...
  const renderButton = (
    <Stack direction="row" alignItems="center">
      ...
      {mdUp && <Label sx={{ px: 0.75, fontSize: 12, color: 'text.secondary' }}>Ctrl + K</Label>}
    </Stack>
  );
